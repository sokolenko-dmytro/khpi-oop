...
public class Helper {
    ...
    public static ArrayList<Prisoner> object = new ArrayList<>();
    ...
    private static void save(ArrayList<Prisoner> input) {
        int choose;
    ...
    private static ArrayList download() {
        ArrayList<Prisoner> output = new ArrayList<>();
        int choose;
        System.out.println("What type of saving do you wish for: ");
        System.out.println("1 - XML");
        System.out.println("2 - Standard Serialization");
    ...
    private static void settingSearch(ArrayList<Prisoner> input) {
